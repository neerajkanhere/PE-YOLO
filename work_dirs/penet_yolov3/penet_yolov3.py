...
data_root = '/home/yin/Desktop/data/Exdark'
...
data = dict(
    ...
    train=dict(
        type='ExdarkDataset',
        ann_file='/home/yin/Desktop/data/Exdark/main/train.txt',
        img_prefix='/home/yin/Desktop/data/Exdark/JPEGImages/IMGS',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='ExdarkDataset',
        ann_file='/home/yin/Desktop/data/Exdark/main/val.txt',
        img_prefix='/home/yin/Desktop/data/Exdark/JPEGImages/IMGS',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/penet_yolov3'
gpu_ids = [0]
